...
export declare function sendConfig(iframe: HTMLIFrameElement | Element | undefined, pendingMap: Map<string, PendingRequest> | null, config: Pick<PayConductorConfig, "orderId" | "theme" | "locale" | "paymentMethods" | "defaultPaymentMethod" | "showPaymentButtons">): Promise<void>;
